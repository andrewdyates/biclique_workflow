...
{
  std::cout<<std::endl<<"Maximal Biclique Generator 1.0. Released July 04, 2012. Copyright(C) The Network Laboratory of Biomedical Informatics, The Ohio State University (netlab.bmi.osumc.edu)."<<std::endl<<std::endl;
  ...
  std::cout << "Starting MBC, version 1.0\n";
