...
static void usage() {
	cout<<endl<<"SumNetwork Version 1.2. Released July 04, 2012. Copyright(C) The Network Laboratory of Biomedical Informatics, The Ohio State University (netlab.bmi.osumc.edu)."<<endl;
	cout << "\nUsage:\n"
...
int main(int argc, char* argv[]) {
	...
	cout<<endl<<"SumNetwork Version 1.2. Released July 04, 2012. Copyright(C) The Network Laboratory of Biomedical Informatics, The Ohio State University (netlab.bmi.osumc.edu)."<<endl<<endl;
